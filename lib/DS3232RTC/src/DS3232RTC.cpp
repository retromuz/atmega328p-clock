...
void DS3232RTC::setAlarm(ALARM_TYPES_t alarmType, byte seconds, byte minutes,
...
void DS3232RTC::setAlarm(ALARM_TYPES_t alarmType, byte minutes, byte hours,
		byte daydate) {
